# -*- coding: utf-8 -*-
"""
Created on Fri Jul  6 21:48:26 2018
...
def get_cluster(grid_set):
    ...
    mycluster_area={}
    i=0
    for ind0 in range(0,len(grid_set)):
        temp1=grid_set[ind0]
        res=[]
        res.append(temp1)
        for ind1 in range(ind0+1,len(grid_set)):            
            temp2=grid_set[ind1]
